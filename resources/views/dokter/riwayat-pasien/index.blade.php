                ...
                <table class="table table-zebra w-full">
                    ...
                    <tbody>
                        ...
                        <tr class="hover:bg-slate-50 transition">
                            ...
                            <td class="px-6 py-4 text-right"> <a href="{{ route('riwayat-pasien.show', $riwayat) }}" class="btn btn-sm bg-blue-500 hover:bg-blue-600 text-white border-none rounded-lg px-4"> <i class="fas fa-eye"></i> Detail </a> </td>
